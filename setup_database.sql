-- تشغيل هذا الملف على قاعدة البيانات لإعداد النظام
...
-- إضافة بيانات الأقسام (إذا لم تكن موجودة)
...
INSERT IGNORE INTO employees (FullName, Email, NationalID, DepartmentID, RoleID, Status, HireDate) VALUES
...
CREATE INDEX IF NOT EXISTS idx_requests_type ON requests(ComplaintType);
CREATE INDEX IF NOT EXISTS idx_requests_submission_date ON requests(SubmissionDate);
CREATE INDEX IF NOT EXISTS idx_workflow_request_id ON request_workflow(RequestID);
