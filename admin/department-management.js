...
async function loadDepartmentEmployees() {
    try {
        ...
        const response = await fetch('/api/admin/department/employees', {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
...
async function loadDepartmentComplaints() {
    try {
        ...
        const response = await fetch('/api/admin/department/complaints', {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
...
async function viewComplaintDetails(complaintId) {
    try {
        ...
        const response = await fetch(`/api/admin/complaints/${complaintId}/details`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
...
async function loadAssignmentHistory(complaintId) {
    try {
        ...
        const response = await fetch(`/api/admin/complaints/${complaintId}/assignments`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
            }
...
async function assignComplaint() {
    ...
    try {
        ...
        const response = await fetch(`/api/admin/complaints/${currentComplaintId}/assign`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
