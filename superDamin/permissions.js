...
function getRolePermissions(roleName) {
  const permissions = {
    'ADMIN': [
      {
        id: 'manage_department_complaints',
        name: 'إدارة شكاوى القسم',
        description: 'إدارة الشكاوى الخاصة بقسمه فقط',
        enabled: true
      },
      {
        id: 'manage_department_employees',
        name: 'إدارة موظفي القسم',
        description: 'إدارة الموظفين التابعين لقسمه',
        enabled: true
      },
      {
        id: 'view_department_reports',
        name: 'عرض تقارير القسم',
        description: 'عرض التقارير الخاصة بقسمه',
        enabled: true
      },
      {
      ...
      {
        id: 'manage_employee_permissions',
        name: 'إدارة صلاحيات الموظفين',
        description: 'إدارة صلاحيات موظفي قسمه',
        enabled: true
      }
    ],
    'EMPLOYEE': [
      ...
      {
        id: 'view_personal_reports',
        name: 'عرض التقارير الشخصية',
        description: 'عرض تقاريره الشخصية',
        enabled: true
      }
    ]
  };
