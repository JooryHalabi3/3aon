        ...
        if (notifList) {
            notifList.innerHTML = `
                <div class="notif-item error-notif">
                    ...
                    <button onclick="loadNewComplaints()" style="margin-top: 8px; padding: 4px 8px; background: #3b82f6; color: white; border: none; border-radius: 4px; cursor: pointer;">إعادة المحاولة</button>
                </div>
            `;
        }
        
        // إخفاء العدّاد في حالة الخطأ
        const countEl = document.getElementById('notifCount');
        if (countEl) {
